...
import com.qianyishen.domain.ProcessFilterIpKeySum;
 ...
 */
public interface IProcessFilterIpKeySumService {
     ...
     * @return 原始数据的list集合
     */
    List<ProcessFilterIpKeySum> findProIpKeySumRawdataWithoutBlackIp(Timestamp timestamp);
     ...
     */
    ProcessIpThresholdList analyzeCrawlersByProIpKeySum(ProcessIpThresholdList processIpThresholdList, Timestamp timestamp);
