...
import com.qianyishen.domain.ProcessFilterIpSum;
 ...
 */
public interface IProcessFilterIpSumService {
     ...
     * @return 原始数据的list集合
     */
    List<ProcessFilterIpSum> findProIpSumRawdataWithoutBlackIp(Timestamp timestamp);
     ...
     */
    ProcessIpThresholdList analyzeCrawlersByProIpSum(ProcessIpThresholdList processIpThresholdList, Timestamp timestamp);
